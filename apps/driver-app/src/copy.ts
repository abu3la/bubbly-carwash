...
export const copy = {
  ...
  evidenceInstruction: 'اختر فيديو 360° كاملًا، أو صوّر الجهات الأربع بوضوح قبل الانتقال للمرحلة التالية.',
  takePhotos: 'التقاط صور',
  record360: 'تسجيل فيديو 360°',
  photoAngles: { front: 'الأمام', right: 'اليمين', rear: 'الخلف', left: 'اليسار' } as Record<string, string>,
